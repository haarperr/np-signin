CreateThread(function()
  ...
  -- Sandy PD
  exports["np-polytarget"]:AddCircleZone("officer_sign_in", vector3(1853.78, 3690.95, 34.28), 0.3, {
    useZ=true,
  })

  -- Paleto PD
  exports["np-polytarget"]:AddCircleZone("officer_sign_in", vector3(-450.41, 6012.82, 31.72), 0.3, {
    useZ=true,
  })
  ...
  -- Prison
  exports["np-polytarget"]:AddCircleZone("officer_sign_in", vector3(1840.22, 2584.38, 46.01), 0.44, {
    useZ = true
  })
