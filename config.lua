...
MenuData = {
  officer_sign_in = {
    ...
    },
    {
      ...
      key = "doc",
      children = {
          { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "doc" } },
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } }
      }
    }
  },
  ems_sign_in = {
    {
      ...
      key = "ems",
      children = {
          { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "ems" } },
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } },
      }
    },
    {
      ...
      key = "doctor",
      children = {
          { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "doctor" } },
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } },
      }
    },
    {
      ...
      key = "therapist",
      children = {
          { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "therapist" } },
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } },
      }
    }
  },
  ems_volunteer_sign_in = {
    {
      ...
      children = {
          ...
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } },
          {
            ...
            children = {
              { title = "Ambulance", action = "np-signin:spawnVehicle", key = VOLUNTEER_VEHICLES.STANDARD },
            }
         },
      }
    }
  ...
  fire_dept_sign_in = {
    {
      ...
      children = {
          ...
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } },
          {
            ...
            children = {
              { title = "Firetruck", action = "np-signin:spawnVehicle", key = VOLUNTEER_VEHICLES.FIRETRUCK },
            }
         },
      }
    }
  ...
  public_services_sign_in = {
    {
      ...
      key = "mayor",
      children = {
          { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "mayor" } },
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "judge",
      children = {
          { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "judge" } },
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "defender",
      children = {
        { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "defender" } },
        { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      children = {
        { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "district attorney" } },
        { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } }
      }
    }
  },
  driving_instructor_sign_in = {
    {
      ...
      children = {
          { title = "Sign In", action = "np-signin:handler", key = { sign_in = true, job = "driving instructor" } },
          { title = "Sign Out", action = "np-signin:handler", key = { sign_off = true } },
      }
    }
  }
